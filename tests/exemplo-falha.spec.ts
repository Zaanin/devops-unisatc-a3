...
test.describe('Testes que Falham Intencionalmente', () => {
  test('exemplo de teste que falha - descomente para testar PR com erro', async ({ page }) => {
    // Este teste sempre vai falhar
    expect(true).toBe(false);
  });

  test('exemplo de timeout intencional', async ({ page }) => {
  ...
  test('exemplo de assertion incorreta', async ({ page }) => {
